...
public class PlayerAttribute : MonoBehaviour
{
    ...
    private int m_ShoeJumpCountCount; // Player specific
    ...
    public int ShoeJumpCountCount { get => m_ShoeJumpCountCount; set => m_ShoeJumpCountCount = value; }
    ...
    public int ShoeJumpCount => ShoeJumpCountCount * UpgradesConfig.ShoeJumpCount;
